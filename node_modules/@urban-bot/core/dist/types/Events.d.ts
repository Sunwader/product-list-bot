...
export declare type UrbanSyntheticEvent<BotType extends UrbanBotType> = UrbanSyntheticEventAction<BotType> | UrbanSyntheticEventVoice<BotType> | UrbanSyntheticEventCommand<BotType> | UrbanSyntheticEventInvoice<BotType> | UrbanSyntheticEventAnimation<BotType> | UrbanSyntheticEventAudio<BotType> | UrbanSyntheticEventVideo<BotType> | UrbanSyntheticEventText<BotType> | UrbanSyntheticEventPoll<BotType> | UrbanSyntheticEventImage<BotType> | UrbanSyntheticEventFile<BotType> | UrbanSyntheticEventContact<BotType> | UrbanSyntheticEventSticker<BotType> | UrbanSyntheticEventLocation<BotType> | UrbanSyntheticEventDice<BotType> | UrbanSyntheticEventAny<BotType>;
export declare type UrbanSyntheticEventByType<BotType extends UrbanBotType, T extends UrbanSyntheticEvent<BotType>['type']> = T extends 'text' ? UrbanSyntheticEventText<BotType> : T extends 'command' ? UrbanSyntheticEventCommand<BotType> : T extends 'sticker' ? UrbanSyntheticEventSticker<BotType> : T extends 'animation' ? UrbanSyntheticEventAnimation<BotType> : T extends 'audio' ? UrbanSyntheticEventAudio<BotType> : T extends 'contact' ? UrbanSyntheticEventContact<BotType> : T extends 'file' ? UrbanSyntheticEventFile<BotType> : T extends 'invoice' ? UrbanSyntheticEventInvoice<BotType> : T extends 'location' ? UrbanSyntheticEventLocation<BotType> : T extends 'image' ? UrbanSyntheticEventImage<BotType> : T extends 'poll' ? UrbanSyntheticEventPoll<BotType> : T extends 'dice' ? UrbanSyntheticEventDice<BotType> : T extends 'voice' ? UrbanSyntheticEventVoice<BotType> : T extends 'action' ? UrbanSyntheticEventAction<BotType> : T extends 'video' ? UrbanSyntheticEventVideo<BotType> : T extends 'any' ? UrbanSyntheticEventAny<BotType> : UrbanSyntheticEvent<BotType>;
...
export declare type UrbanSyntheticEventType<BotType extends UrbanBotType> = UrbanSyntheticEvent<BotType>['type'];
...
export declare type SpreadField<T, K extends keyof T> = Omit<T, K> & T[K];
